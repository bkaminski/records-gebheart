...
// TAG SUPPORT TO PAGES
function tags_support_all() {
    register_taxonomy_for_object_type('post_tag', 'page');
}

// TAGS INCLUDED IN QUERIES
...
{
    global $post;
    return $output . '<a class="btn btn-lg btn-green text-uppercase rounded-pill text-white pr-4 pl-4" href="' . get_permalink() . '">Read More <i class="fas fa-angle-double-right fa-fw fa-lg"></i></a>';
}
...
//begin pagination
function gebhart_pagination($pages = '', $range = 1)
{
    $showitems = ($range * 2) + 1;
