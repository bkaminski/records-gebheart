	...
	<div class="portal">
		<div class="container pt-5">
			...
			<div class="row pb-5">
				...
				<div class="col-md-4 pb-4 text-center">
					<picture>
						<a target="_blank" href="https://www.lititzmutual.com/">
							<img src="<?php echo get_home_url();?>/wp-content/uploads/lititz-mutual.png" class="img-fluid" alt="Lititz Mutual Logo" width="250" />
						</a>
					</picture>
				</div>
			</div>
			<div class="row pb-5">
				...
				<div class="col-md-4 pb-4 text-center">
					<picture>
						<a target="_blank" href="https://www.markelinsurance.com/">
							<img src="<?php echo get_home_url();?>/wp-content/uploads/markel.png" class="img-fluid" alt="Markel Logo" width="150" />
						</a>
					</picture>
				</div>
				<div class="col-md-4 pb-4 pt-4 text-center">
					<picture>
						<a target="_blank" href="https://www.phly.com/Home/Index.aspx">
							<img src="<?php echo get_home_url();?>/wp-content/uploads/philadelphia-insurance.png" class="img-fluid" alt="Philadelphia Insurance Company Logo" width="350" />
						</a>
					</picture>
				</div>
			</div>
			...
			<div class="row pb-5">
				...
				<div class="col-md-4 pb-4 text-center">
					<picture>
						<a target="_blank" href="https://usassure.com/">
							<img src="<?php echo get_home_url();?>/wp-content/uploads/US-assure.png" class="img-fluid" alt="US Assure Logo" width="250" />
						</a>
					</picture>
				</div>
				<div class="col-md-4 pb-4 text-center">
			...
			<div class="row text-center pb-5">
				<div class="col-md-12">
					<picture>
						<a target="_blank" href="https://www.nbic.com/">
							<img src="<?php echo get_home_url();?>/wp-content/uploads/narragansett-insurance.png" class="img-fluid" alt="Narragansett Insurance Logo" width="350" />
						</a>
					</picture>
				</div>
			</div>
